    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="prose prose-gray max-w-none">
        ...
        <p className="text-gray-700 mb-4">
          By accessing and using EdgeBook, you accept and agree to be bound by the terms and provision of this agreement.
        </p>

        <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">2. Age Requirement</h2>
        <p className="text-gray-700 mb-4">
          You must be at least 18 years old to use this service. By using EdgeBook, you represent that you are at least 18 years of age.
        </p>

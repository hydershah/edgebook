export default function Disclosures() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-3xl font-bold text-gray-900 mb-6">Disclosures</h1>
      <div className="prose prose-gray max-w-none">
        ...
        <p className="text-gray-700 mb-4">
          EdgeBook charges a 15% platform fee on all premium pick purchases. This fee is clearly displayed before purchase.
        </p>

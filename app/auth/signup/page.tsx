    ...
    <div className="min-h-screen flex bg-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-black relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          <h1 className="text-5xl font-bold mb-4">EdgeBook</h1>
          <p className="text-xl text-gray-300 max-w-md">
            Join the community where sports betting meets social intelligence.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 lg:px-16">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden mb-10">
            <h1 className="text-3xl font-bold text-black mb-2">EdgeBook</h1>
          ...
          <div className="hidden lg:block mb-10">
            ...
            <p className="text-gray-600">Join EdgeBook today</p>
          </div>
          ...
          <div className="w-full">
            ...
            {/* Success Message */}
            {success && (
              <div className="mb-6 bg-green-50 border border-green-100 rounded-xl p-4 flex items-start">
            ...
            <div className="space-y-3 mb-8">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-3.5 border border-gray-200 rounded-xl bg-white hover:bg-gray-50 transition-all duration-200 font-medium text-gray-900 disabled:opacity-50 disabled:cursor-not-allowed hover:border-gray-300"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3.5 border rounded-xl focus:ring-2 focus:ring-black focus:border-black transition-all duration-200 outline-none text-base ${
                      fieldErrors.name ? 'border-red-400 focus:ring-red-300' : 'border-gray-200'
                    }`}
                    required
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3.5 border rounded-xl focus:ring-2 focus:ring-black focus:border-black transition-all duration-200 outline-none text-base ${
                      fieldErrors.email ? 'border-red-400 focus:ring-red-300' : 'border-gray-200'
                    }`}
                    required
                    disabled={loading || socialLoading !== null}
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3.5 border rounded-xl focus:ring-2 focus:ring-black focus:border-black transition-all duration-200 outline-none text-base ${
                      fieldErrors.password ? 'border-red-400 focus:ring-red-300' : 'border-gray-200'
                    }`}
                    required
                    disabled={loading || socialLoading !== null}
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3.5 border rounded-xl focus:ring-2 focus:ring-black focus:border-black transition-all duration-200 outline-none text-base ${
                      fieldErrors.confirmPassword ? 'border-red-400 focus:ring-red-300' : 'border-gray-200'
                    }`}
                    required
                    disabled={loading || socialLoading !== null}
              ...
              <div className="text-xs text-gray-600 bg-gray-50 p-4 rounded-xl border border-gray-100">
                ...
                <Link href="/legal/terms" className="text-black hover:underline font-medium">
                  Terms of Service
                </Link>{' '}
                and{' '}
                <Link href="/legal/privacy" className="text-black hover:underline font-medium">
                  Privacy Policy
                </Link>
              </div>
              ...
              <button
                type="submit"
                disabled={loading || socialLoading !== null}
                className="w-full bg-black hover:bg-gray-800 text-white font-semibold py-3.5 px-4 rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? (
